...
import { Card, FlexBox, TextInput, EmailInput, PasswordInput, TelInput } from "solid-lib/ui";
            ...
            <FlexBox gap={16} wrap="wrap">
                <Card class={styles.card}>
                    ...
                    <FlexBox gap={16} dir="column">
                        <TextInput label="用户名" value={username()} changed={setUsername} validate={validateUsername} />
                        <PasswordInput
                            label="密码"
                            value={password()}
                            changed={setPassword}
                        ...
                        />
                        <PasswordInput label="确认密码" value={confirm()} changed={setConfirm} validate={validateConfirm} />
                    </FlexBox>
                </Card>
                ...
                <Card class={styles.card}>
                    ...
                    <FlexBox gap={16} dir="column">
                        ...
                        />
                        <EmailInput label="邮箱（远程查重）" value={email()} changed={setEmail} validate={checkEmailRemote} />
                        <TelInput
                            label="手机号"
                            value={phone()}
                            changed={setPhone}
