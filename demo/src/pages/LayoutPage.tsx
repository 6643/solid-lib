    ...
    <div class={styles.page}>
      ...
      <FlexBox gap={16} wrap="wrap">
        ...
        <Card class={styles.card}>
          ...
          >
            ...
            <div class={styles.box} style={{ "min-height": "100px" }}>主内容区</div>
      ...
      <FlexBox gap={16} wrap="wrap">
        <Card class={styles.card}>
          ...
          <StackBox pos={[{ x: 0, y: 0 }, { x: 20, y: 20 }, { x: 40, y: 40 }]}>
            <div class={styles.box} style={{ width: "120px", height: "80px", background: "#e91e63" }}>底层</div>
            <div class={styles.box} style={{ width: "120px", height: "80px", background: "#9c27b0" }}>中层</div>
            <div class={styles.box} style={{ width: "120px", height: "80px", background: "#673ab7" }}>顶层</div>
          </StackBox>
        </Card>
