...
import { icon_remove, icon_add } from "./SvgIcon"
...
export const Counter = (props: {
    ...
    const increment = props.max !== undefined && getVal() >= props.max ? undefined : () => {
    ...
    const decrement = props.min !== undefined && getVal() <= props.min ? undefined : () => {
        const currentValue = getVal()
